...
var makeControls, makeSlideshow, root;
...
root.App = {
  mount: function(_slides, _controls, location) {
    ...
    return setTimeout(function() {
      return document.body.classList.add('animate');
    });
  }
};
...
clicker = function(n, i) {
  ...
  set = function(j, delta) {
    return [i = j, delta];
  };
  go = function(j) {
    return set((j + n) % n, j - i);
  };
  step = function(d) {
    return go(i + d);
  };
...
trigger = function(clicker, render) {
  var f, k, out;
  out = {};
  for (k in clicker) {
    f = clicker[k];
...
traverse = function(key) {
  return function(el) {
    ...
    results = [];
    while (el && (ref2 = [el[key], el], el = ref2[0], ref = ref2[1], ref2)) {
      results.push(ref);
    }
    return results;
  };
...
patch = function(el) {
  var ref2;
  return el.matchesSelector != null ? el.matchesSelector : el.matchesSelector = (ref2 = el.webkitMatchesSelector) != null ? ref2 : el.mozMatchesSelector;
};
